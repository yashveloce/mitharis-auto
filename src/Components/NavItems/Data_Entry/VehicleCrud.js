...
function VehicleCrud()
{
    ...
    const onFormSubmit=(e)=>
    {
        ...
        insertStockData({variables:{
            ...
            engine_displacement:stock.vehicle_master,
    ...
    const onModalFormSubmit=(e)=>
    {
        ...
        upateStockData({variables:{
            ...
            engine_displacement:modalStock.vehicle_master,
          ...
          renderCell: (params) => {
            return (
              <div className="" style={{ width: "100%", textAlign: 'center', margin: '0 40px' }}>
                ...
                <button style={{ marginLeft: '20%' }} className="btn btn-danger" data-toggle="tooltip" title="Delete"><i className="fa fa-trash"></i></button>
      ...
      <div className="col-md-12">
        ...
        <div className="row">  
          ...
          <div className="row">
            ...
            <div className="field col-md-6">
              <label>Transmission</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="transmission" type="text" placeholder='Enter Your Transmission' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>Chess Number</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="chess_no" type="text" placeholder='Enter Your Chess Number' required />
            </div>
            <div className="field col-md-6">
              <label>Transfer</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="transfer" type="text" placeholder='Enter Your Transfer' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>Insurance</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="insurance" type="text" placeholder='Enter Your Insurance' required />
            </div>
            <div className="field col-md-6">
              <label>NOC</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="noc" type="text" placeholder='Enter Your NOC' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>HP</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="hp" type="text" placeholder='Enter Your HP' required />
            </div>
            <div className="field col-md-6">
              <label>Average</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="average" type="text" placeholder='Enter Your Average' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>Accidental</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="accidental" type="text" placeholder='Enter Your HP' required />
            </div>
            <div className="field col-md-6">
              <label>Registered</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="registered" type="text" placeholder='Enter Your Average' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>Expected Price</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="expected_price" type="text" placeholder='Enter Your HP' required />
            </div>
            <div className="field col-md-6">
              <label>Bank_loan</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="bank_loan" type="text" placeholder='Enter Your Average' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>Installment</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="installment" type="text" placeholder='Enter Your HP' required />
            </div>
            <div className="field col-md-6">
              <label>Loan Amount</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="loan_amount" type="text" placeholder='Enter Your Average' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>Extra Keys</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="extra_keys" type="text" placeholder='Enter Your HP' required />
            </div>
            <div className="field col-md-6">
              <label>Stepny</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="stepny" type="text" placeholder='Enter Your Average' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>Owner</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="owner" type="text" placeholder='Enter Your HP' required />
            </div>
            <div className="field col-md-6">
              <label>Buyer</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="buyer" type="text" placeholder='Enter Your Average' required />
            </div>
          </div>
          <div className="row">
            <div className="field col-md-6">
              <label>Taxposition</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="taxposition" type="text" placeholder='Enter Your HP' required />
            </div>
            <div className="field col-md-6">
              <label>Body Color</label>
              <input className="form-control" onChange={e=>onInputChange(e)} name="body_color" type="text" placeholder='Enter Your Average' required />
            </div>
          </div>
          <div className="field" style={{ width: '100%', textAlign: 'center', marginTop: '20px' }}>
            <button className="btn btn-primary" type='submit' style={{ marginRight: '50px' }}>Save</button>
